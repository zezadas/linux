...
static int wm8994_codec_probe(struct snd_soc_codec *codec)
{
	...
	// wm8994_priv = snd_soc_codec_get_drvdata(codec);
	// if (!wm8994_priv) {
	// 	dev_err(codec->dev, "failed to initialize WM8994. No drvdata.\n");
	// }
			    ...
			    const struct i2c_device_id *id)
{
	...
	// i2c_set_clientdata(client, wm8994_priv);
...
#ifdef CONFIG_OF
static const struct of_device_id wm8994_dt_match[] = {
	{ .compatible = "samsung,wm8994" },
	{ },
};
MODULE_DEVICE_TABLE(of, wm8994_dt_match);
#endif

static struct i2c_driver wm8994_i2c_driver = {
	.driver = {
		   .name = "WM8994 I2C Codec",
		   .of_match_table = of_match_ptr(wm8994_dt_match),
		   .owner = THIS_MODULE,
		   },
