...
static struct dvfs_client dvfs_core_clients[] = {
	...
	DVFS_CORE_CLIENT(mpe, 1, 142500,	190000,	275500, 300000),
	...
	DVFS_CORE_CLIENT(sclk, 1, 123500,	159500,	207000,	240000,	240000,	264000,	277500),
	DVFS_CORE_CLIENT(sclk, 2, 152000,	180500,	229500,	260000, 285000,	300000),

	DVFS_CORE_CLIENT(vde, 1, 123500,	152000,	237500,	300000),
